...
>";
        ...
        $message = "<div class='row'>";
        $message .= "<div class='col-md-2'><a href='logout.php' class='btn btn-success'>logout</a></div
>";
        $message .= "</div>";
        echo $message;
    }
    ...
    ?>
    <p>Share your stories with friends, family and friends from all over the world on <code>Fakebook<
/code>.</p>
